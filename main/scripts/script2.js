...
function desvirar(carta) {
    ...
    carta.innerHTML =
        "<div class = \"cabecario\">" + carta.valor + "<br>" + carta.naipe + "</div>" +
        // "<div class = \"meio\">"+carta.naipe+"</div>" +
        desenhos(carta.valor, carta.naipe) +
        "<div class = \"rodape\">" + carta.valor + "<br>" + carta.naipe + "</div>";
...
function comprar() {
    ...
    desvirar(this);
    // if(divComprado.childElementCount > 1)
    // divComprado.childNodes[divComprado.childElementCount-1].classList.remove('sombra');
    ...
    // divComprado.childNodes[divComprado.childElementCount-1].classList.add('sombra');
}
...
function voltarCartas(e) {
    ...
    while (divComprado.childElementCount != 0) {
        ...
        divComprado.childNodes[divComprado.childElementCount - 1].addEventListener('mouseup', comprar);
        divBaralho.appendChild(divComprado.childNodes[divComprado.childElementCount - 1]);
    }

    divBaralho.firstChild.classList.remove('sombra');
    divBaralho.lastChild.classList.add('sombra');
    // divBaralho.childNodes[divBaralho.childElementCount-1].classList.add('sombra');
}
    ...
    if (this.parentNode.classList[0] == "naipe") {
        if (this.naipe == cartaArrastada.naipe) {
            if (addNaipe(this, cartaArrastada)) {
                ...
                // this.classList.remove('sombra');
                // this.parentNode.appendChild(cartaArrastada);
                // isWin();
            } else return;
        ...
        // cartaArrastada.classList.add('sombra');
        // this.appendChild(cartaArrastada);
        // cartaArrastada.setAttribute("style", "top: 20px;");
...
function handleDragOver(e) {
    if (e.preventDefault) {
        e.preventDefault(); // necessario para funcionar
    }
}
...
function selecionarCarta(e) {
    ...
    if (cartaSelecionada == null) {
        ...
        if (this.parentNode.classList[0] == "carta" || this.parentNode.classList[0] == "casa") {
            if (addApCarta(cartaSelecionada, this)) {
                // cartaSelecionada.setAttribute("style", "top: 20px;");
            ...
            if (addNaipe(this, cartaSelecionada)) {
                ...
                // if(cartaSelecionada.parentNode.classList[0] == "carta")
                // desvirar(cartaSelecionada.parentNode)
                // this.parentNode.appendChild(cartaSelecionada);
            }
...
function addNaipe(de, para) {
    switch (de.valor.toString() + para.valor.toString()) {
        ...
        case "KA":
            ...
            if (para.parentNode.classList[0] == "carta")
                desvirar(para.parentNode)
            ...
            switch (para.naipe + de.naipe) {
                ...
                case "♣♦":
                    ...
                    if (de.parentNode.classList[0] == "carta") {
                        ...
                        var espoa = de.parentNode.childNodes[de.parentNode.childElementCount - 2];
                        if (espoa != null)
                            espoa.classList.add('sombra');
                    }
                    para.appendChild(de);
...
function desenhos(valor, naipe) {
    ...
    switch (valor.toString()) {
        case "2":
            retorno += "&nbsp&nbsp " + naipe + " &nbsp&nbsp<br><br><br><br><br><br>" +
                "&nbsp&nbsp " + naipe + " &nbsp&nbsp";

            break;
        case "3":
            retorno += "&nbsp&nbsp " + naipe + " &nbsp&nbsp<br><br><br>" +
                "&nbsp&nbsp " + naipe + " &nbsp&nbsp<br><br><br>" +
                "&nbsp&nbsp " + naipe + " &nbsp&nbsp";

            break;
        case "4":
            retorno += naipe + " &nbsp&nbsp " + naipe + "<br><br><br><br><br><br>" +
                naipe + " &nbsp&nbsp " + naipe + "";

            break;
        case "5":
            retorno += naipe + " &nbsp&nbsp " + naipe + "<br><br><br>" +
                "&nbsp&nbsp " + naipe + " &nbsp&nbsp<br><br><br>" +
                naipe + " &nbsp&nbsp " + naipe;
        ...
        case "6":
            retorno += naipe + " &nbsp&nbsp " + naipe + "<br><br><br>" +
                naipe + " &nbsp&nbsp " + naipe + "<br><br><br>" +
                naipe + " &nbsp&nbsp " + naipe;

            break;
        case "7":
            retorno += naipe + " &nbsp&nbsp " + naipe + "<br><br><br>" +
                naipe + " " + naipe + " " + naipe + "<br><br><br>" +
                naipe + " &nbsp&nbsp " + naipe;

            break;
        case "8":
            retorno += naipe + " &nbsp&nbsp " + naipe + "<br><br>" +
                naipe + " &nbsp&nbsp " + naipe + "<br><br>" +
                naipe + " &nbsp&nbsp " + naipe + "<br><br>" +
                naipe + " &nbsp&nbsp " + naipe;
        ...
        case "9":
            retorno += naipe + " &nbsp&nbsp " + naipe + "<br><br>" +
                naipe + " &nbsp&nbsp " + naipe + "<br>" +
                "&nbsp&nbsp " + naipe + " &nbsp&nbsp<br>" +
                naipe + " &nbsp&nbsp " + naipe + "<br><br>" +
                naipe + " &nbsp&nbsp " + naipe;
            break;

        case "10":
            retorno += naipe + " &nbsp&nbsp " + naipe + "<br>" +
                "&nbsp&nbsp " + naipe + " &nbsp&nbsp<br>" +
                naipe + " &nbsp&nbsp " + naipe + "<br><br>" +
                naipe + " &nbsp&nbsp " + naipe + "<br>" +
                "&nbsp&nbsp " + naipe + " &nbsp&nbsp<br>" +
